...
# Inference
bash ./scripts/test_gencadcode.sh "../checkpoints/qwen3vl8b_5epoch" "deepcad_test_data_subset100"
# Generate CAD and compute IoU
conda activate cad_iou
python3 ./scripts/generate_model_cad.py --dataset_name deepcad_test_data_subset100 --model_tested qwen3vl8b_5epoch --code_language cadquery --parallel
python3 ./scripts/compute_iou.py --model_path qwen3vl8b_5epoch --test_set_name deepcad_test_data_subset100 --ground_truth_steps_dir ../inference/test100_gt_steps_deepcad/
...
### ITS
conda activate vlmtrl
python3 ./scripts/test_api_infscaling_rewrite.py
conda activate pyocc
python3 ./scripts/summary_of_cadquery_logs_loops.py
